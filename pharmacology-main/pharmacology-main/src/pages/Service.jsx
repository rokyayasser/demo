...
// ─── Animation variants (defined BEFORE component to avoid ReferenceError) ───
...
const Service = () => {
  ...
  const { Medicalservices, loading: contextLoading } =
  ...
  if (contextLoading && Medicalservices.length === 0) {
    return (
            ...
            >
              {filteredServices.map((item, index) => (
                <motion.div
                  ...
                  className={`relative border border-borderLight rounded-2xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-300 bg-white ${
                ...
                >
                  ...
                  {!item.available && (
                    <>
                      <div className="absolute inset-0 bg-gray-900/20 backdrop-blur-[1px] z-10 pointer-events-none"></div>
                  ...
                  <div className="p-6">
                    <div className="flex items-start justify-between mb-3">
                      ...
                      <div
                        className={`flex items-center gap-1 px-2 py-1 rounded-full text-xs ml-2 flex-shrink-0 ${
                          item.available
                    ...
                    <div className="flex items-center justify-between mb-6">
                      ...
                      <span
                        className={`text-sm ${!item.available ? "text-gray-400" : "text-textSoft"}`}
                      >
                    ...
                    {/* Book button */}
                    <motion.button
                      whileHover={item.available ? { scale: 1.03 } : {}}
                    ...
                    >
                      {item.available ? "احجز موعد" : "غير متاح للحجز"}
                    </motion.button>
                  </div>
                </motion.div>
              ))}
